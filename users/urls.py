...
from users.views import (CoursePaymentAPIView, PaymentCreateAPIView, PaymentListAPIView, PaymentRetrieveAPIView,
                         PaymentSuccessAPIView, UserCreateAPIView, UserDestroyAPIView, UserListAPIView,
